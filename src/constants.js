...
export const treatments = [
    { img: "https://img.icons8.com/external-others-pike-picture/100/external-Bariatric-Surgery-bariatric-others-pike-picture.png", name: "Bariatric Surgery" },
    { img: "https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/external-cardiac-allergy-flaticons-lineal-color-flat-icons.png", name: "Cardiac Sciences" },
    { img: "https://img.icons8.com/external-obivous-color-kerismaker/100/external-anatomy-anatomy-color-obivous-color-kerismaker-32.png", name: "Cardiothoracic & Vascular Surgery" },
    { img: "https://img.icons8.com/external-tal-revivo-duo-tal-revivo/50/external-doctor-available-for-the-health-and-blood-type-blood-duo-tal-revivo.png" , name: "Clinical Hematology & BMT" },
    { img: "https://img.icons8.com/external-flaticons-lineal-color-flat-icons/128/external-head-anatomy-flaticons-lineal-color-flat-icons-5.png", name: "ENT" },
    { img: "https://img.icons8.com/external-justicon-lineal-color-justicon/100/external-stomach-human-organs-justicon-lineal-color-justicon.png", name: "Gastroenterology Surgery" },
    { img: "https://img.icons8.com/arcade/64/surgery.png", name: "General Surgery" },
    { img: "https://img.icons8.com/external-tal-revivo-fresh-tal-revivo/50/external-medication-for-the-females-prescribed-by-a-gynecology-drugs-fresh-tal-revivo.png", name: "Gynaecology Treatment" },
    { img: "https://img.icons8.com/doodle/96/drop-of-blood--v1.png", name: "Haematology & BMT" },
    { img: "https://img.icons8.com/external-others-pike-picture/100/external-Liver-Transplant-hepatitis-others-pike-picture.png", name: "Liver Transplant Surgery" },
    { img: "https://img.icons8.com/pulsar-color/100/cancer-ribbon.png", name: "Medical Oncology" },
    { img: "https://img.icons8.com/doodle/96/kidney--v1.png", name: "Nephrology" },
    { img: "https://img.icons8.com/pulsar-color/100/brain-stroke.png", name: "Neuro Sciences" },
    { img: "https://img.icons8.com/external-beshi-color-kerismaker/100/external-Neurology-medical-service-beshi-color-kerismaker.png", name: "Neurology" },
    { img: "https://img.icons8.com/ios-glyphs/90/periods.png", name: "Obstetrics & Gynecology" },
    { img: "https://img.icons8.com/external-flatart-icons-lineal-color-flatarticons/64/external-oncology-world-cancer-awareness-flatart-icons-lineal-color-flatarticons.png", name: "Oncology" },
    { img: "https://img.icons8.com/external-tal-revivo-fresh-tal-revivo/100/external-bone-disorder-orthopedics-department-in-same-hospital-premises-hospital-fresh-tal-revivo.png", name: "Orthopedics" },
    { img: "https://img.icons8.com/ios/100/chromatography.png", name: "Pediatric Cardiac Surgery" },
    { img: "https://img.icons8.com/fluency/100/non-ionizing-radiation.png", name: "Radiation Oncology" },
    { img: "https://img.icons8.com/ios/100/surgical-scissors.png", name: "Surgical Oncology" },
    { img: "https://img.icons8.com/external-inipagistudio-lineal-color-inipagistudio/64/external-transplant-cancer-care-inipagistudio-lineal-color-inipagistudio.png" , name: "Transplant" },
    { img: "https://img.icons8.com/external-beshi-color-kerismaker/100/external-Urology-medical-service-beshi-color-kerismaker.png", name: "Urology Surgery" },
    { img: "https://img.icons8.com/color/100/spleen.png", name: "Vascular Surgery" }
];
