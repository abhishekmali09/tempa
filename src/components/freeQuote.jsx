  ...
  return (
    <div className='grayish py-20'>
       ...
       <div className='flex flex-col items-center justify-center gap-1'>
        ...
        <p className='text-center font-text text-lg px-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur numquam vel perspiciatis suscipit cum pariatur explicabo consectetur nostrum a rem?</p>
