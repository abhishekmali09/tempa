...
import MainImage from "/Images/hero_main.png"
const HeroSection = () => {
  return (
    <section className='flex grayish flex-col-reverse lg:gap-0 gap-8  lg:flex-row h-screen'>
        <div className='flex flex-col gap-4 sm:max-w-screen lg:w-1/2 w-full justify-center items-center pb-10'>
            <p className='text-xl font-heading'>Quality Care</p>
        ...
        <div className='sm:max-w-screen lg:w-1/2 w-full'>
