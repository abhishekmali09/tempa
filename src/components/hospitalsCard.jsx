...
const HospitalsCard = ({hospitalDetail}) => {
  return (
    <div className="flex gap-4 mx-auto flex-col justify-between  max-w-[30rem] h-[30rem] p-10  hover:shadow-lg hover:shadow-[#403e3c] border-[1px] hover:scale-102 duration-850 rounded-4xl">
