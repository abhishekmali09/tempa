        ...
        <div className='bg-[#faf3eb] max-w-screen'>
            <div className=' w-full flex items-end lg:flex-row flex-col pt-30 pb-10'>
                <div className='lg:w-1/2 w-full flex justify-center items-center p-10'>
                    <div className=' grid grid-cols-2 grid-rows-6 gap-4 justify-center max-w-[400px]'>
                                <h1 className='text-6xl col-start-1 row-start-1 col-span-2 row-span-2'>Free Quote</h1>
                                ...
                                <p className='font-semibold col-start-2 row-start-3'>{ContactInformation.address}</p>
                                <p className='font-semibold col-start-2 row-start-4'>{ContactInformation.contactNumber}</p>
                                <p className='font-semibold col-start-2 row-start-5'>{ContactInformation.emailAddress}</p>
